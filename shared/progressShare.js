// shared/progressShare.js - Sharing functionality
// Plain script (not ES module) — instantiated by per-app gameController
class ProgressShare {
    constructor(progressTracker, progressChart, appName = 'Maths') {
    ...
    generateSummary(levelKey = null) {
        ...
        let text = `📊 ${this.appName} Progress Report\n`;
    ...
    generatePrintableReport() {
        ...
        const html = `
            ...
            <html>
            <head>
                <title>${this.appName} Progress Report</title>
                <style>
            ...
            <body>
                <h1>${this.appName} Progress Report</h1>
