...
export default new BaseLevel('inverseTrigDiffHard', 'Differentiating Inverse Trig — Hard', [
  ...
  { problem: '\\frac{d}{dx}(\\tan^{-1}(e^x))', answer: '\\frac{e^x}{1+e^{2x}}' },
  { problem: '\\frac{d}{dx}(\\cos^{-1}(e^x))', answer: '-\\frac{e^x}{\\sqrt{1-e^{2x}}}' },
  { problem: '\\frac{d}{dx}(\\cos^{-1}(e^{2x}))', answer: '-\\frac{2e^{2x}}{\\sqrt{1-e^{4x}}}' },
  { problem: '\\frac{d}{dx}(\\sin^{-1}(\\ln x))', answer: '\\frac{1}{x\\sqrt{1-(\\ln x)^2}}' },
  { problem: '\\frac{d}{dx}(\\tan^{-1}(\\ln x))', answer: '\\frac{1}{x(1+(\\ln x)^2)}' },
  { problem: '\\frac{d}{dx}\\left(\\sin^{-1}\\sqrt{x}\\right)', answer: '\\frac{1}{2\\sqrt{x}\\sqrt{1-x}}' },
  { problem: '\\frac{d}{dx}\\left(\\cos^{-1}(2\\sqrt{x})\\right)', answer: '-\\frac{1}{\\sqrt{x}\\sqrt{1-4x}}' },
  { problem: '\\frac{d}{dx}(e^x\\tan^{-1}x)', answer: 'e^x\\tan^{-1}x+\\frac{e^x}{1+x^2}' },
  { problem: '\\frac{d}{dx}((\\sin^{-1}x)^2)', answer: '\\frac{2\\sin^{-1}x}{\\sqrt{1-x^2}}' },
  { problem: '\\frac{d}{dx}((\\tan^{-1}x)^2)', answer: '\\frac{2\\tan^{-1}x}{1+x^2}' },
  { problem: '\\frac{d}{dx}((\\tan^{-1}x)^3)', answer: '\\frac{3(\\tan^{-1}x)^2}{1+x^2}' },
  { problem: '\\frac{d}{dx}(e^{\\tan^{-1}x})', answer: '\\frac{e^{\\tan^{-1}x}}{1+x^2}' },
  { problem: '\\frac{d}{dx}(\\tan^{-1}(\\sin x))', answer: '\\frac{\\cos x}{1+\\sin^2 x}' },
  { problem: '\\frac{d}{dx}(\\tan^{-1}(2e^x))', answer: '\\frac{2e^x}{1+4e^{2x}}' },
