...
export default new BaseLevel('trigIntEasy', 'Trigonometric — Easy', [
  ...
  { problem: '\\int 3\\sin x\\,dx', answer: '-3\\cos x+C' },
  ...
  { problem: '\\int\\sin 3x\\,dx', answer: '-\\frac{1}{3}\\cos 3x+C' },
  { problem: '\\int\\cos(4x)\\,dx', answer: '\\frac{1}{4}\\sin(4x)+C' },
  { problem: '\\int\\sin(4x)\\,dx', answer: '-\\frac{1}{4}\\cos(4x)+C' },
  { problem: '\\int\\sin(5x)\\,dx', answer: '-\\frac{1}{5}\\cos(5x)+C' },
  { problem: '\\int\\sec^2(5x)\\,dx', answer: '\\frac{1}{5}\\tan(5x)+C' },
  { problem: '\\int 6\\cos(3x)\\,dx', answer: '2\\sin(3x)+C' },
  { problem: '\\int 4\\sin(2x)\\,dx', answer: '-2\\cos(2x)+C' },
  { problem: '\\int 10\\sin(5x)\\,dx', answer: '-2\\cos(5x)+C' },
  { problem: '\\int 9\\sec^2(3x)\\,dx', answer: '3\\tan(3x)+C' },
  { problem: '\\int\\frac{1}{2}\\cos x\\,dx', answer: '\\frac{1}{2}\\sin x+C' },
  { problem: '\\int\\frac{1}{3}\\cos(3x)\\,dx', answer: '\\frac{1}{9}\\sin(3x)+C' },
  { problem: '\\int\\cos\\frac{x}{2}\\,dx', answer: '2\\sin\\frac{x}{2}+C' },
  { problem: '\\int\\cos\\frac{x}{4}\\,dx', answer: '4\\sin\\frac{x}{4}+C' },
