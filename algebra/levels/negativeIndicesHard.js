...
export default new BaseLevel(
    ...
    [
            ...
            {problem: "\\left\\left(\\frac{a^2b^3}{b^{-2}}\\right\\right)^2 \\div \\left\\left(\\frac{ab^4}{a^2}\\right\\right)^{-2}", answer: "a^2b^{18}"},
            {problem: "\\left\\left(\\frac{x^4y^{-2}}{a^3}\\right\\right)^2 \\div \\left\\left(\\frac{x^{-3}y^2}{a^3}\\right\\right)^2", answer: "\\frac{x^{14}}{y^8}"},
            ...
            {problem: "\\left\\left(\\frac{x^3y^{-1}}{y^2}\\right\\right)^2 \\div \\left\\left(\\frac{xy^3}{x^{-1}}\\right\\right)^{-2}", answer: "x^{10}"},
            {problem: "\\left\\left(\\frac{2x^{-2}y^4}{y^{-1}}\\right\\right)^3 \\div \\left\\left(\\frac{xy^{-2}}{x^2}\\right\\right)^2", answer: "\\frac{8y^{19}}{x^4}"},
            ...
            {problem: "\\left\\left(\\frac{2x^{-1}y^3}{y^{-2}}\\right\\right)^{-2} \\div \\left\\left(\\frac{x^2y}{x^{-1}}\\right\\right)^3", answer: "\\frac{1}{4x^7y^{13}}"},
            {problem: "\\left\\left(\\frac{x^3y^{-4}}{x^{-1}}\\right\\right)^2 \\div \\left\\left(\\frac{2xy^2}{y^{-1}}\\right\\right)^{-1}", answer: "\\frac{2x^9}{y^5}"},
            ...
            {problem: "\\left\\left(\\frac{3a^2b^{-3}}{b}\\right\\right)^3 \\div \\left\\left(\\frac{ab^{-1}}{a^{-2}}\\right\\right)^{-2}", answer: "\\frac{27a^{12}}{b^{14}}"},
            {problem: "\\left\\left(\\frac{x^{-1}y^4}{y^{-2}}\\right\\right)^{-1} \\div \\left\\left(\\frac{2xy^{-1}}{x^2}\\right\\right)^3", answer: "\\frac{x^4}{8y^3}"},
