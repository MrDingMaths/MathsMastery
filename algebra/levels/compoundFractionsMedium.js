...
export default new BaseLevel(
    ...
    [
            ...
            {problem: "\\frac{1+\\frac{4}{x}}{1-\\frac{4}{x}}", answer: "\\frac{x+4}{x-4}"},
            {problem: "\\frac{2-\\frac{y}{x}}{2+\\frac{y}{x}}", answer: "\\frac{2x-y}{2x+y}"},
            {problem: "\\frac{\\frac{x}{3}+\\frac{y}{4}}{\\frac{x}{3}-\\frac{y}{4}}", answer: "\\frac{4x+3y}{4x-3y}"},
            {problem: "\\frac{x^{-1}-y^{-1}}{x^{-1}+y^{-1}}", answer: "\\frac{y-x}{y+x}"},
            {problem: "a^{-2}+a^{-1}", answer: "\\frac{a+1}{a^2}"},
            {problem: "\\frac{\\frac{a}{b}+2}{2-\\frac{a}{b}}", answer: "\\frac{a+2b}{2b-a}"}
        ]
);
