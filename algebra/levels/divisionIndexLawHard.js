...
// Tier principle: coefficient division produces a non-integer fractional result (e.g. 4/3, 5/2),
// OR three distinct variables simultaneously, OR double negatives, OR negative combined with fractional coefficient or inverse exponent case.
export default new BaseLevel(
    ...
    [
            ...
            // Migrated from Medium (fractional coefficients or three distinct variables)
