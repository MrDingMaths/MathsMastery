...
export default new BaseLevel(
    ...
    [
            ...
            {problem: "\\left\\left(\\frac{2\\sqrt{6}}{3}\\right\\right)^3 \\times \\frac{9}{8\\sqrt{6}}", answer: "2"},
            {problem: "\\left\\left(\\frac{3\\sqrt{5}}{2}\\right\\right)^2 \\times \\left\\left(\\frac{4\\sqrt{3}}{3}\\right\\right)^2", answer: "60"},
            ...
            {problem: "\\frac{(3\\sqrt{2})^3}{2} \\times \\frac{(2\\sqrt{5})^2}{5}", answer: "108\\sqrt{2}"},
            ...
            {problem: "\\left\\left(\\frac{\\sqrt{72}}{\\sqrt{8}}\\right\\right)^2 \\times \\left\\left(\\frac{\\sqrt{50}}{\\sqrt{2}}\\right\\right)^2", answer: "225"},
            ...
            {problem: "\\left\\left(\\frac{4\\sqrt{21}}{\\sqrt{84}}\\right\\right)^2 \\times \\frac{(3\\sqrt{7})^2}{9}", answer: "28"},
            {problem: "\\frac{(2\\sqrt{45})^3 \\times \\sqrt{5}}{(3\\sqrt{20})^2 \\times \\sqrt{25}}", answer: "6"},
            {problem: "\\frac{(4\\sqrt{3})^2}{6} \\times \\frac{(2\\sqrt{6})^3}{8}", answer: "48\\sqrt{6}"},
            {problem: "\\frac{(4\\sqrt{3})^3}{6} \\div \\frac{(2\\sqrt{6})^2}{3}", answer: "4\\sqrt{3}"},
            {problem: "\\left\\left(\\frac{3\\sqrt{2}}{4}\\right\\right)^2 \\times \\left\\left(\\frac{4\\sqrt{6}}{3}\\right\\right)^2", answer: "12"},
            {problem: "\\frac{(2\\sqrt{5})^3}{10} \\div \\frac{(3\\sqrt{2})^2}{6}", answer: "\\frac{4\\sqrt{5}}{3}"},
            {problem: "\\left\\left(\\frac{6\\sqrt{8}}{4\\sqrt{2}}\\right\\right)^3 \\times \\frac{\\sqrt{16}}{9}", answer: "12"},
