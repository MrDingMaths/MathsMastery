...
export default new BaseLevel(
    ...
    [
            ...
            {problem: "\\frac{2x+7}{3x} + \\frac{5x-4}{6x^2}", answer: "\\frac{4x^2+19x-4}{6x^2}"},
            ...
            {problem: "\\frac{5x+2}{3x} + \\frac{4x-1}{6x^2}", answer: "\\frac{10x^2+8x-1}{6x^2}"},
            
            // Advanced algebraic fraction combinations
            {problem: "\\frac{4x-3}{3x} + \\frac{2x+5}{x^2}", answer: "\\frac{4x^2+3x+15}{3x^2}"},
            {problem: "\\frac{2y^2-3}{3y^2} + \\frac{y+4}{y}", answer: "\\frac{5y^2+12y-3}{3y^2}"},
            {problem: "\\frac{5x-2}{4x} - \\frac{3x+1}{2x^2}", answer: "\\frac{5x^2-8x-2}{4x^2}"},
